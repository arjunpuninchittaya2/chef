...
function Et(n, o) {
    ...
    if (t(n, o)) {
        const t = n.type;
        if ("INPUT" === s && ("button" === t || "submit" === t || "reset" === t)) return r;
        if (!r || "OPTION" === s) return;
        return e;
    }
    return "OPTION" === s || "SELECT" === s ? n.value : "INPUT" === s || "TEXTAREA" === s ? r : void 0;
}
const Nt = /url\((?:(')([^']*)'|(")([^"]*)"|([^)]*))\)/gm,
    It = /^[A-Za-z]+:|^\/\//,
    bt = /^["']?data:.*,/i;
...
function Ot(e, n, s) {
    ...
    if (e.value && ("textarea" === i || "select" === i || "option" === i || "input" === i)) {
        const t = Et(e, n);
        void 0 !== t && (r.value = t);
    }
    if ("option" === i) {
    ...
    switch (n.kind) {
        case 0:
            (a = Math.round(t.scrollTop)),
                ...
                (a || c) && n.scope.elementsScrollPositions.set(t, { scrollTop: a, scrollLeft: c });
            break;
        case 1:
            n.scope.elementsScrollPositions.has(t) &&
                ({ scrollTop: a, scrollLeft: c } = n.scope.elementsScrollPositions.get(t));
    }
...
function zt(t, e, n) {
    switch (t.nodeType) {
        ...
        case t.DOCUMENT_TYPE_NODE:
            return (function (t, e) {
                return { type: st, id: e.assignId(t), name: t.name, publicId: t.publicId, systemId: t.systemId };
            })(t, n);
        case t.ELEMENT_NODE:
            return (function (t, e, n) {
                const s = (function (t) {
                ...
                return { type: rt, id: c, tagName: s, attributes: m, childNodes: h, isSVG: r };
            })(t, e, n);
        case t.TEXT_NODE:
            return (function (t, e, n) {
                const o = c(t, e);
...
function $t(t, e, n, o, s) {
    const r = [],
        i = { cssText: { count: 0, max: 0, sum: 0 }, serializationDuration: { count: 0, max: 0, sum: 0 } },
        a = {
            add(t) {
                r.push(t);
            },
        ...
        c = g();
    s(a), Ft(i, "serializationDuration", y(c, g()));
...
function Ut(t, e, n, o, s) {
    $t(e, n, o, s, (e) => {
        ...
        e.add({ data: { height: o, href: window.location.href, width: n }, type: Z, timestamp: t }),
            e.add({ data: { has_focus: document.hasFocus() }, type: Q, timestamp: t }),
            e.add({ data: { node: Ht(document, e), initialOffset: { left: S(), top: w() } }, type: J, timestamp: t }),
            window.visualViewport && e.add({ data: Gt(window.visualViewport), type: et, timestamp: t });
    });
}
function Yt(t) {
...
function Wt(t, e) {
    const { throttled: n, cancel: o } = N(
        ...
        { stop: s } = I(e.configuration, document, ["mousemove", "touchmove"], n, { capture: !0, passive: !0 });
    return {
        stop: () => {
            s(), o();
        },
...
function Kt(t, e) {
    return I(
        ...
        (n) => {
            const s = jt(n),
                r = e.nodeIds.get(s);
            if (void 0 === r || b(s, e.configuration.defaultPrivacyLevel) === o.HIDDEN) return;
            const i = Jt[n.type];
            let a;
            if (i !== wt && i !== vt) {
                const t = qt(n);
...
function Zt(t, e, n) {
    const { throttled: s, cancel: r } = N((t) => {
            ...
            if (void 0 === r || b(s, n.configuration.defaultPrivacyLevel) === o.HIDDEN) return;
            const i =
                s === document
                    ? { scrollTop: w(), scrollLeft: S() }
                    : { scrollTop: Math.round(s.scrollTop), scrollLeft: Math.round(s.scrollLeft) };
            n.elementsScrollPositions.set(s, i), e(Xt(ft, { id: r, x: i.scrollLeft, y: i.scrollTop }));
        }, 100),
        { stop: i } = T(n.configuration, t, "scroll", s, { capture: !0, passive: !0 });
    return {
        stop: () => {
            i(), r();
        },
...
function te(t, e) {
    ...
    const { throttled: o, cancel: s } = N(
        ...
        { stop: r } = I(e.configuration, n, ["resize", "scroll"], o, { capture: !0, passive: !0 });
    return {
        stop: () => {
            r(), s();
        },
...
function ne(t, e) {
    ...
    const o = [
        D(CSSStyleSheet.prototype, "insertRule", ({ target: e, parameters: [o, s] }) => {
            n(e, (e) => t(Xt(yt, { id: e, adds: [{ rule: o, index: s }] })));
        }),
        D(CSSStyleSheet.prototype, "deleteRule", ({ target: e, parameters: [o] }) => {
            n(e, (e) => t(Xt(yt, { id: e, removes: [{ index: o }] })));
        }),
    ];
    function s(e) {
        o.push(
            D(e.prototype, "insertRule", ({ target: e, parameters: [o, s] }) => {
                n(e.parentStyleSheet, (n) => {
                    const r = oe(e);
                    r && (r.push(s || 0), t(Xt(yt, { id: n, adds: [{ rule: o, index: r }] })));
                });
            }),
            D(e.prototype, "deleteRule", ({ target: e, parameters: [o] }) => {
                n(e.parentStyleSheet, (n) => {
                    const s = oe(e);
                    s && (s.push(o), t(Xt(yt, { id: n, removes: [{ index: s }] })));
                });
            })
        );
    }
    return (
        "undefined" != typeof CSSGroupingRule ? s(CSSGroupingRule) : (s(CSSMediaRule), s(CSSSupportsRule)),
        {
            stop: () => {
                o.forEach((t) => t.stop());
            },
...
function re(t, e, n) {
    const o = t.subscribe(12, (t) => {
        ...
        t.rawRumEvent.type === _.ACTION &&
            ...
            (null === (s = null === (o = t.rawRumEvent.action.frustration) || void 0 === o ? void 0 : o.type) ||
            void 0 === s
                ? void 0
                : s.length) &&
...
function ae(e, n, s) {
    ...
    function l(t, e) {
        ...
        if (void 0 === o) return;
        const r = i.get(t);
        (r && r.text === e.text && r.isChecked === e.isChecked) || (i.set(t, e), n(Xt(mt, { id: o, ...e })));
    }
}
function ce(t, e, n, s) {
    const r = k();
                ...
                (function (t, e) {
                    ...
                    const s = t.filter(
                            (t) =>
                                ...
                                b(t.target, e.scope.configuration.defaultPrivacyLevel, n) !== o.HIDDEN
                        ),
                        {
                            adds: r,
                            removes: i,
                            ...
                            for (const f of i) {
                                if (d(f)) continue;
                                const t = b(f.parentNode, n.scope.configuration.defaultPrivacyLevel, e);
                                if (t === o.HIDDEN || t === o.IGNORE) continue;
                                const s = zt(f, t, n);
                                if (!s) continue;
                                const r = x(f);
                                c.push({ nextId: l(f), parentId: n.scope.nodeIds.get(r), node: s });
                            }
                            const u = [];
                            return (
                                r.forEach((t, e) => {
                                    ...
                                    void 0 !== o && void 0 !== s && u.push({ parentId: o, id: s });
                                }),
                        ...
                        u = (function (t, e, n) {
                            ...
                            for (const u of a) {
                                ...
                                const i = b(x(u.target), n.scope.configuration.defaultPrivacyLevel, e);
                                i !== o.HIDDEN &&
                                    i !== o.IGNORE &&
                                    r.push({ id: t, value: null !== (s = c(u.target, i)) && void 0 !== s ? s : null });
                            }
                            return r;
                        })(
                            ...
                            const o = [],
                                ...
                                r = t.filter((t) => {
                                    ...
                                    return (
                                        ...
                                        (e ? e.add(t.attributeName) : s.set(t.target, new Set([t.attributeName])), !0)
                                    );
                                }),
                                i = new Map();
                            for (const a of r) {
                                ...
                                if (void 0 === t) continue;
                                const s = b(a.target, n.scope.configuration.defaultPrivacyLevel, e),
                                ...
                                u || ((u = { id: t, attributes: {} }), o.push(u), i.set(a.target, u)),
...
function de(t) {
    ...
    const r = (n) => {
        ...
        a = (function (t, e, n, o, s) {
            return { configuration: t, elementsScrollPositions: e, eventIds: n, nodeIds: o, shadowRootsController: s };
        })(
            o,
            (function () {
                const t = new WeakMap();
            ...
            addStats: function (t) {
                !(function (t, e) {
                    for (const n of ["cssText", "serializationDuration"])
                        (t[n].count += e[n].count), (t[n].max = Math.max(t[n].max, e[n].max)), (t[n].sum += e[n].sum);
                })(i, t);
            },
            flush: function (t) {
            ...
            addRecord: (t) => {
                if (2 !== s.status) {
                    if (0 === s.status) {
                        ...
                        s = {
                            status: 1,
                            segment: le({ encoder: o, context: t, creationReason: s.nextSegmentCreationReason }),
...
function he(t, e, n, o, s, r, i) {
    const a = [],
        c =
            ...
            X(
                ...
                (e) => {
                    t.notify(14, { error: e }), q("Error reported to customer", { "error.message": e.message });
                },
                pe
            );
    let u, d;
            ...
            const { unsubscribe: n } = e.subscribe((t) => {
                if (
                    ...
                    const s =
                        ...
                        (n = t.bandwidth),
                        {
                            cssText: { count: (o = t.payload).cssText.count, max: o.cssText.max, sum: o.cssText.sum },
    ...
    const { stop: l } = de({ emitRecord: u, emitStats: d, configuration: e, lifeCycle: t, viewHistory: o });
    return (
        a.push(l),
        {
            stop: () => {
